...
SemaphoreHandle_t pass_song_semaphore;
...
int main(void) {
  ...
  pass_song_semaphore = xSemaphoreCreateBinary();
...
void pause_isr(void) {xSemaphoreGiveFromISR(play_pause_semaphore, NULL); }
